...
class SnapchatAutomaticFieldsTest(SnapchatBase):

    def name(self):
        return "tap_tester_snapchat_ads_automatic_fields_test"
    ...
    def test_run(self):
        ...
        expected_streams = self.expected_streams() - known_failing_streams
